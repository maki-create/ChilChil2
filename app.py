...
result_labels = {
    ...
    "ENFJ": ("ムードメーカー", "ムードメーカータイプのあなた！ 友達とワイワイ推し活をすることが好きで、推しによって人生が彩られているリーダーさん。基本的に推しだけを愛で、応援の声を届ける一途で平和なオタ活を好みます。基本的に誰とでも仲良くなれるタイプのリーダーさんですが、平和主義ゆえ他のオタクさんとの熱量の差に悩んでしまうかも……？ たまには1人でのんびりしてみるのもいいかもしれません。"),

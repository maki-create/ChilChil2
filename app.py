...
# 質問データ
categories = {
     "カテゴリー1": ["気になるコンテンツがあっても、ブクマなどしないでまた時間が経てば流れてくるのを待つ", "今のアニメより2010年代に流行ったアニメが好きだ", "他人による作品やキャラクターの解釈を知るために、掲示板等を利用したりする","質問5",],
     "カテゴリー2": ["占いは信じるほうだ", "3次元ではないキャラクターでもいつか会って会話をしている自分が想像できる", "最初否定していたコンテンツに、なにかのきっかけでどっぷり沼ってしまう"],
     "カテゴリー3": ["接触イベントでのファン対応が良い人が好き", "推しの交友関係の中で素行が悪い人がいると心配になる", "「推しのグッズは絶対に手に入れたい」"],

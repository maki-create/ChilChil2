...
def result_page():
    ...
    result_description = result_labels.get(result_name, "診断結果の説明が見つかりません。")
    ...
    if st.button("元のページに戻る"):
        ...
        st.experimental_set_query_params(page="diagnosis")  # 診断ページに戻る
...
def diagnosis_page():
    ...
    if st.button("診断を実行"):
        ...
        st.experimental_set_query_params(page="result")  # 結果ページに遷移

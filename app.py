...
result_labels = {
    ...
    "INTJ": ("理想主義者", "あなたは計画的に物事を進める戦略家タイプです。論理的に考え、目標達成に向けて努力します。"),
    ...
    "ISTJ": ("管理者", "理想主義者タイプのあなた！推しに対して無限の愛を注ぐ理想主義者さんは、自分にも他人にもストイック。推しを原動力に自分にも投資できる努力家さんです。しかし複雑な想いを隠すためつい1人引きこもってしまいがち……？ 信頼できる人を見つけて共有してみてね"),
    ...
    "ISTP": ("研究者", "あなたは実践的なスキルを持ち、手を動かしながら学ぶのが得意なタイプです。冷静な判断力もあります。"),
    "ENTJ": ("指導者", "研究者タイプのあなた！推しや好きな関係性の2人の分析を怠らない研究者さんは、黙々と情報を集める能力に長けています。やろうと思えば自給自足も可能な研究者さんですが、たまに人の意見や解釈が欲しくなってしまいそう？交流の輪を広げてみると、新たな推しが見えてくる……かもしれません。"),

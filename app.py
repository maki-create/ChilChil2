...
categories = {
     ...
     "カテゴリー2": ["(10)推しの絶対的な味方でいたい",
                "(11)推しではなくても人気芸能人の結婚報告に一喜一憂してしまう",
                ...
                ,"(16)推しは近い存在でいてほしいが、夢をかなえる姿が見たいので、ビッグになってほしいと思う"
                 ,"(17)5年以上推しているコンテンツがある"
                ,"(18)推しが何かがきっかけでバズったり、人気が上がったりすると自分のことのように嬉しい"],
     "カテゴリー3": ["(19)推しの動画編集や画像編集するのが好き",
     ...
     "カテゴリー4": ["(28)どんな推しでも見逃したくないのでチェックを欠かさない",
                ...
                ,"(35)合言葉は「来月の自分が頑張る」と言いながらクレジットカードを使う",
                "(36)グッズが届いても何を買ったか覚えていない",],
    "カテゴリー5": ["(37)イラスト、漫画を見るのが好き",
                "(38)色々な世界線の推しが見てみたい",
                "(39)推しに壮絶な過去があると燃える",

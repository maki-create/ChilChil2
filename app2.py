...
sheet = client.open_by_key(spreadsheet_id).worksheet("テスト④")
...
result_labels = {
    "ENFP": ("カリスマ", "推しに一途で、寝ても覚めても生活が推し一色のカリスマさん。周りを圧倒する行動力とパワーの持ち主です。推しやオタク仲間に対していつも肯定的かつ、広い心で接する温かさが魅力。「推しの顔が良すぎて困る」と嘆きつつ、推しの応援に全力投球するのが推し活スタイルです。その結果、気づけば口座残高が一桁減っている……なんてことも⁉ 常に金欠状態なので非オタクからはお金の使い方について呆れられ、同じオタクからさえ「ビビる」と言われるほどの情熱家。「全肯定オタク」といわれることもありますが、そんな苦言を活力に変えてしまうポジティブさが特徴。超マイペースに楽しくオタク生活を謳歌しており、推しへの貢ぎ方には尊敬の念を向けているオタクが近くにいるかもしれません！口座残高と向き合いつつこれからもオタク街道を突き進んでください。"),
    "ESFJ": ("支援者", "「推しが幸せならOKです！」タイプの優しきオタクである支援者さん。公式の展開や他オタクとの解釈違いはあまり気にしません。みんなの関係性を見守る「壁ポジション」として、周囲には同じく平和を愛するオタク仲間が集まりやすいでしょう。推しコンテンツには穏やかなストーリーを求めますが、万が一推しが悲しい結末を迎えても、転生IFや現代IFなど別の形で2人を幸せにできるくらい想像力も豊かです。現実主義者として私生活を優先できるしっかり者ですが、時に自分へのダメージに鈍感なところもあるので、辛いときは休息も大切に！"),
    "INFP": ("ユートピアン", "推しのすべてを愛し、かつ妄想に忙しいユートピアンさん。一度考え込むと止まらない集中力で、寝る前のブクマや推し関連タグの徘徊に没頭します。どんなに翌日の予定が詰まっていても、この大切な時間だけは削れず、丑三つ刻を過ぎてもネットをさまよいがち。特に金曜の夜は、この世で一番好きな「妄想タイム」。リア恋さんの場合は「推しと結婚できないけど結婚できる」といった幻想に身を任せることも。お金もよく使いますが、推し活には時間をいっぱい使っている方もいるのでは……？自由な時間は推しへの妄想をしてしまいますよね。繊細な心の持ち主なので、他のオタクの言動で思わぬダメージを受けてしまうことがありますが、時には自分を甘やかしながら、推しとの素敵な妄想の世界を楽しんでくださいね！"),
    ...
    "ESFP": ("デザイナー", "収集家気質で消費意欲旺盛なデザイナーさん。欲しいと思ったグッズの購入は当然だが、商品のラインナップを見た時には欲しいと思わなかったグッズも周りの人が持っていると欲しくなることがありそうですね。購入したグッズの開封の儀を行う時に至高の幸せを感じることができ、自分の周りを推し関連のグッズで彩りたい！推しから栄養素を摂取して生きているオタクです。公式グッズ以外にも概念○○を探し出すオタクはこのタイプに一番多そう。生活空間のすべてを推しで彩ろうとする姿勢は、まさに「死ぬほどオタクで死ぬほどオシャレ」。推しカプへの信念は強く、原作で二人が不幸な結末を迎えても「来世で幸せにさせる、俺が！」と豊かな想像力で、新たな物語を紡ぎ出しオタクから称賛されます。コミュニティ内での自分の立ち位置を理解しているので、その役割を果たすことに生きがいを感じています。"),
    "ISTJ": ("ジャーナリスト", "一見非オタクと見紛うほど一般人に同化しているジャーナリストさん。推しのことは心から大好きですが、いわゆる「推し活の経済戦争」には参加するような無理はしません。「公式」と名のつく情報源には惜しみなく投資する研究者気質の一面を見せることも。一日の終わりに自分の解釈を深め、妄想に浸る時間を何よりも大切にしています。ひっそりと一人で推し活を楽しむスタイルは心地よいのですが、時に無自覚のうちに行き場のない感情を持て余してしまうことも……？鍵アカウントで行き場のない気持ちを吐き出し感情を昇華することは、心の安定につながることでしょう。情報収集と妄想の世界で、これからも理想的な推し活を楽しんでください！"),
    ...
    "ENTJ": ("演出家", "楽しいことに目がなくフットワークが軽い演出家さん。お財布と時間に余裕があれば、お友達同士でオタ活を楽しみます。交友関係が広く、多くのイベントに誘われる人気者なので、推し活ダブルブッキングを回避しながら今日もイベントに向かいます。一人の推しを真っすぐ見つめ応援することで大きな充実感を得られます。ただ推しの不遇にダメージを受けやすいことも。また推し活の中で、お金の使い方など考え方の違いでモヤモヤしたり、同担にはちょっとした警戒心を抱きがちなところも。推しを通してつながった友達は人生の大きな財産です。そんな時は一人で抱え込まず、信頼できるオタク友達に相談してみましょう。"),
    "ISFJ": ("マネージャー", "ゆったりと推し活を充実させるマネージャーさん。ひっそりと一人で推し活を楽しみ、自分であれこれ考え様々な解釈を漁りはするものの、最終的には原作に帰結する原点回帰型のオタクです。人の意見も柔軟に取り入れられます。通勤時間や寝る前の癒しとして推しが存在し、ストーリーを読むのが何より好きなのですが、基本課金はしないというスタンスです。派手なお金使いをしないので一般人に見られがちですが、脳内はしっかりオタクだったりします。揉め事が苦手なのでひっそりと平和に無理のない推し活が心地よいのですが、ときに刺激不足に感じることも。そんなとき新たな世界に飛び込んでみると、きっと違った楽しみが待っているはずです！"),
    "ENFJ": ("ムードメーカー", "友達と一緒に推し活をすることが大好きで、推し活が人生に彩りを添えている社交的なムードメーカーさん。基本的に推し一人を純粋に愛で、応援の声を届ける一途で平和なオタ活を好む優しいオタクです。同担拒否もあまりなく、誰とでも分け隔てなく仲良くなれる包容力があり、どんな推しでも基本的に受け入れる広い心を持っています。運営に対しても不満をあまり持たない穏やかな姿勢が特徴的です。推しのことが大好きで同じオタク友達とも平和なコミュニティを作る才能があるムードメーカーさんですが、周りの人にやや流されやすい一面もあるかも……ムードメーカーさんはマイペースに推し活をしているので気にすることは少ないかもしれませんね。これからもあなたらしい推し活を続けていってください！"),
    "ESTJ": ("思想家", "推しにとっての幸せとはなにか…推しグループの関係性はどうか…など推しに関連することについて昼夜問わず思考を巡らせる思想家さん。その脳内は、まるで分厚い哲学書のように深い考察で満ちています。推し活は一人よりも誰かと共有したいタイプですが、オタク友達の条件はやや厳しめかも。推しには自分なりの確固たる解釈があるため、それと合わないオタクとは初めから距離を置く現実的な一面も。周囲の友人は同じような価値観を持つ人が多く、金銭感覚や解釈面でも揉めることは少ないでしょう。グッズ購入は自分の欲しいと思ったものを吟味して買うタイプ。推しコンテンツのイベントにも頻繁には通わないものの、大事なイベントや気の合う仲間との交流は大切にしています。たまには別のコンテンツや仲間に触れてリフレッシュするのもいいかもしれませんね！"),
    "ESTP": ("投資家","カップル推し（またはグループ推し）が多い投資家さん。推しを深く理解するため常に供給を反芻するため、推しに対する解釈に揺るぎない信念を持っています。その思いを伝えるために時間とお金を使うことを厭いません。ときめいたグッズは無意識でカートにぶち込むのでお会計に進んだ時の予想外の合計金額に驚いた経験がある人もいるのではないでしょうか。また推しの幸せのためなら「ご祝儀」気分で簡単に追加投資してしまいます。結果なんでこんなに出費多いんだろう…？と大真面目に考えることも。お金は使っているのではなく自然と出て行ってしまう感覚です。 とはいえ推し活で得られる充実感は望外なリターン。自分の限界を突破することがないように資金管理を大切に楽しいオタ活ライフを♪"),
    "INTP": ("株主", "推しをひっ    そり見守り支える株主さん。物事を深く考える洞察力があり、推しの将来について黙々と考えを巡らせる参謀のような存在です。これまで投資したお金は株主総会での議決権。推しが納得できない扱いを受けると運営に権利の行使を申し出ることも。持ち株数が他のオタクとはゼロ一つ違うのですが、自分以上に投資している猛者を常に見ているため感覚の差に気づいていないかも。一途で熱量も無尽蔵なため、推しが自分の理想と違う方向性に向いてしまうと深刻なメンタルブレイクを起こす不安もあります。ただ推しへの深い愛情と献身は、他のオタクにはない素晴らしい能力。日々自分をケアする方法を増やしてサステナブルオタ活をエンジョイしましょう。")}
...
def diagnosis_page():
    ...
    categories = {
        "カテゴリー1": ["(1)ああああ友達が好きなコンテンツは自分も手を出してみる",
        "(2)SNSのリプでやり取りをよくする", 
